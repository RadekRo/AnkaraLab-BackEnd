...
namespace AnkaraLab_BackEnd.WebAPI.Migrations
{
    ...
    [Migration("20240210173256_newsletter1")]
    partial class newsletter1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnkaraLab_BackEnd.WebAPI.Domain.Newsletter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnkaraLab_BackEnd.WebAPI.Domain.ShippingAdress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnkaraLab_BackEnd.WebAPI.Domain.ShippingAdress", b =>
                {
                    b.HasOne("AnkaraLab_BackEnd.WebAPI.Domain.Client", null)
                        .WithMany("DeliveryAdress")
